...
class AppColor {
  ...
  static Map<int, List<Color>> novelThemes = {
    0: [const Color.fromRGBO(245, 239, 217, 1), const Color(0xff301e1b)],
    1: [const Color.fromRGBO(248, 247, 252, 1), black333],
    2: [const Color.fromRGBO(192, 237, 198, 1), Colors.black],
    3: [const Color(0xff3b3a39), const Color.fromRGBO(230, 230, 230, 1)],
    4: [Colors.black, const Color.fromRGBO(200, 200, 200, 1)],
  };
}
