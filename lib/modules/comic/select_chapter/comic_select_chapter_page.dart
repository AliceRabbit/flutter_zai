...
import 'package:zaix/modules/comic/select_chapter/comic_select_chapter_controller.dart';
            ...
            children: [
              ...
              Expanded(
                child: TextButton.icon(
                  ...
                  icon: const Icon(Remix.checkbox_blank_line, size: 20),
              ...
              Expanded(
                child: TextButton.icon(
                  ...
                  label: Obx(
                    () => Text("下载选中(${controller.chapterIds.length})"),
                  ),
                ),
              ),
            ],
              ...
              children: [
                ...
                item.sortType.value == 1
                    ? TextButton.icon(
                        ...
                        icon: const Icon(Remix.sort_asc, size: 20),
                        label: const Text("升序"),
                      )
                    : TextButton.icon(
                        style: TextButton.styleFrom(
                        ...
                        icon: const Icon(Remix.sort_desc, size: 20),
                        label: const Text("倒序"),
                      ),
              ],
            ),
                        ...
                        () => Stack(
                          children: [
                            OutlinedButton(
                              style: OutlinedButton.styleFrom(
                                foregroundColor:
                                    controller.chapterIds.contains(
                                      chapter.chapterId,
                                    )
                                    ? Colors.blue
                              ...
                              onPressed:
                                  ComicDownloadService.instance.downloadIds
                                      .contains(
                                        "${comicId}_${chapter.chapterId}",
                                      )
                                  ? null
