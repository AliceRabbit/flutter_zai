...
import 'package:zaix/modules/user/local_history/comic/comic_history_controller.dart';
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            NetImage(item.comicCover, width: 80, height: 110, borderRadius: 4),
            AppStyle.hGap12,
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  ...
                  AppStyle.vGap4,
                  Text(
                    "看到${item.chapterName} ${item.page}页",
